...
<head>
    ...
    <style>
        ...
        /* Navigation */
        .navbar-custom {
            background: linear-gradient(135deg, #7e8ef5 0%, #9b9ef5 100%);
        }
...
<body class="bg-secondary bg-opacity-25">
                                    ...
                                    <div class="bg-primary text-white rounded-3 p-3 schedule-item">
                                        <div class="d-flex align-items-start justify-content-between">
                                            ...
                                            <div class="d-flex align-items-start flex-grow-1 me-3">
                                                <!-- Date Box -->
                                                <div class="bg-white bg-opacity-25 rounded text-center px-3 py-2 me-3 flex-shrink-0">
            ...
            <div class="col-12 col-lg-4">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <button class="btn btn-primary w-100 py-3 fs-5 fw-semibold mb-3" onclick="showDeleteConfirmation()">🗑️ Remove Account</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="deleteConfirmationModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>If you remove the account all your saved items will be deleted as well.</p>
    ...
    <script>
        ...
        function showDeleteConfirmation() {
            console.log('showDeleteConfirmation called'); // Debugging log
                ...
                .then(({
                    ...
                    try {
                        ...
                        if (data.success) {
                            ...
                            // Delay redirect to ensure session is destroyed
                            setTimeout(() => {
