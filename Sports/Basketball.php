...
<head>
  ...
  <title>SUSL Basketball Team</title>
...
<section 
  ...
  style="background-image: url('images/bascketballteam.jpg');"
>
  <div class="relative z-10 max-w-3xl mx-auto px-4 bg-black/40 rounded-xl p-6">
    <h2 class="text-4xl font-bold mb-6 text-white">🏀 SUSL Basketball Team</h2>
    <p class="text-lg leading-relaxed text-white/90 mb-4">
      The SUSL Basketball Team is known for its speed, teamwork, precision shooting, and solid defensive strategies. The team competes in inter-university and national competitions.
    </p>
    <p class="text-lg leading-relaxed text-white/90">
      Players train to improve dribbling, passing, shooting accuracy, agility, and overall court awareness, ensuring top performance throughout the season.
    </p>
  ...
  <div class="max-w-5xl mx-auto px-6 space-y-12">
    ...
    <div class="relative bg-gradient-to-br from-blue-100 to-blue-200 rounded-3xl shadow-2xl border border-blue-300 p-10 overflow-hidden hover:scale-105 transform transition duration-500">
      ...
      <p class="text-gray-800 text-lg mb-6">
        The team has earned recognition for strong court performance, discipline, and teamwork across multiple tournaments.
      </p>
      <ul class="list-disc list-inside text-gray-700 font-medium space-y-2">
        <li>Inter-University Basketball Bronze Medal – 2023</li>
        <li>Qualified for National University Games – 2022</li>
        <li>Multiple players selected for provincial teams</li>
      </ul>
    </div>
    ...
    <div class="relative bg-gradient-to-br from-blue-100 to-blue-200 rounded-3xl shadow-2xl border border-blue-300 p-10 overflow-hidden hover:scale-105 transform transition duration-500">
      ...
      <p class="text-gray-800 text-lg mb-6">
        The coaching staff focuses on tactical gameplay, fitness, agility, defense, and shot accuracy. Leaders guide the team with confidence and discipline.
      </p>
      <ul class="list-disc list-inside text-gray-700 font-medium space-y-2">
        <li>Head Coach: Mr. Sandun Karunathilaka</li>
        <li>Assistant Coach: Ms. Ruwangi Dissanayake</li>
        <li>Team Captain: Mr. Akila Pathirana</li>
        <li>Vice-Captain: Mr. Pasindu Madusanka</li>
      </ul>
    </div>
    ...
    <div class="relative bg-gradient-to-br from-blue-100 to-blue-200 rounded-3xl shadow-2xl border border-blue-300 p-10 overflow-hidden hover:scale-105 transform transition duration-500">
      ...
      <p class="text-gray-800 text-lg mb-8">
        Become part of the SUSL Basketball Team and enhance your athletic performance while representing the university in top competitions.
      </p>
