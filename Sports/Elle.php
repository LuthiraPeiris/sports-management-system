...
<section 
  ...
  style="background-image: url('images/elleteam.jpg');"
>
  <div class="relative z-10 max-w-3xl mx-auto px-4 bg-black/40 rounded-xl p-6">
    <h2 class="text-4xl font-bold mb-6 text-white">🥎 SUSL Elle Team</h2>
    <p class="text-lg leading-relaxed text-white/90 mb-4">
      The Sabaragamuwa University Elle Team participates in inter-university and regional tournaments, showcasing skill, agility, and teamwork in both offensive and defensive plays.
    </p>
    <p class="text-lg leading-relaxed text-white/90">
      The team emphasizes strategic play, hand-eye coordination, and fitness. Players are trained rigorously to excel in hitting, fielding, and base running while maintaining discipline and sportsmanship.
    </p>
  ...
  <div class="max-w-5xl mx-auto px-6 space-y-12">
    ...
    <div class="relative bg-gradient-to-br from-blue-100 to-blue-200 rounded-3xl shadow-2xl border border-blue-300 p-10 overflow-hidden hover:scale-105 transform transition duration-500 w-full">
      ...
      <p class="text-gray-800 text-lg mb-6">
        The Elle Team has consistently performed well in inter-university competitions and regional tournaments, winning several medals.
      </p>
    ...
    <div class="relative bg-gradient-to-br from-blue-100 to-blue-200 rounded-3xl shadow-2xl border border-blue-300 p-10 overflow-hidden hover:scale-105 transform transition duration-500 w-full">
      ...
      <p class="text-gray-800 text-lg mb-6">
        Coaches focus on tactical skills, hitting, fielding, and strategy. Captains lead training sessions, match strategies, and inspire teamwork on the field.
      </p>
      <ul class="list-disc list-inside text-gray-700 font-medium space-y-2">
        <li>Head Coach: Mr. Sandun Perera</li>
        <li>Assistant Coach: Ms. Nadeesha Silva</li>
        <li>Team Captain: Ms. Tharushi Perera</li>
        <li>Vice-Captain: Mr. Ruwan Jayasuriya</li>
      </ul>
    </div>
    ...
    <div class="relative bg-gradient-to-br from-blue-100 to-blue-200 rounded-3xl shadow-2xl border border-blue-300 p-10 overflow-hidden hover:scale-105 transform transition duration-500 w-full">
      ...
      <p class="text-gray-800 text-lg mb-8">
        Join the Elle Team to improve your skills, participate in competitions, and represent SUSL with pride in regional and inter-university matches.
      </p>
