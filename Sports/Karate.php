...
<section 
  ...
  style="background-image: url('images/karateteam.jpg');"
>
  <div class="relative z-10 max-w-3xl mx-auto px-4 bg-black/40 rounded-xl p-6">
    <h2 class="text-4xl font-bold mb-6 text-white">🥋 SUSL Karate Team</h2>
    <p class="text-lg leading-relaxed text-white/90 mb-4">
      The Sabaragamuwa University Karate Team trains and competes in national and inter-university karate tournaments, mastering techniques in kumite (sparring) and kata (forms).
    </p>
    <p class="text-lg leading-relaxed text-white/90">
      Focus is on strength, agility, discipline, and precision. Players develop their skills through rigorous training, improving physical fitness and mental focus to excel in competitions.
    </p>
  ...
  <div class="max-w-5xl mx-auto px-6 space-y-12">
    ...
    <div class="relative bg-gradient-to-br from-blue-100 to-blue-200 rounded-3xl shadow-2xl border border-blue-300 p-10 overflow-hidden hover:scale-105 transform transition duration-500 w-full">
      ...
      <p class="text-gray-800 text-lg mb-6">
        The Karate Team has won multiple medals in inter-university and national level competitions, demonstrating excellence in both kata and kumite.
      </p>
      <ul class="list-disc list-inside text-gray-700 font-medium space-y-2">
        <li>Inter-University Karate Champions 2022</li>
        <li>National Level Medalists 2023</li>
        <li>Players selected for national training camps</li>
      </ul>
    </div>
    ...
    <div class="relative bg-gradient-to-br from-blue-100 to-blue-200 rounded-3xl shadow-2xl border border-blue-300 p-10 overflow-hidden hover:scale-105 transform transition duration-500 w-full">
      ...
      <p class="text-gray-800 text-lg mb-6">
        Coaches train players in karate techniques, physical conditioning, and competition strategy. Captains lead team practices and ensure discipline and coordination during matches.
      </p>
      <ul class="list-disc list-inside text-gray-700 font-medium space-y-2">
        <li>Head Coach: Sensei Nimal Perera</li>
        <li>Assistant Coach: Ms. Anushi Silva</li>
        <li>Team Captain: Mr. Chamara Jayasuriya</li>
    ...
    <div class="relative bg-gradient-to-br from-blue-100 to-blue-200 rounded-3xl shadow-2xl border border-blue-300 p-10 overflow-hidden hover:scale-105 transform transition duration-500 w-full">
      ...
      <p class="text-gray-800 text-lg mb-8">
        Join the SUSL Karate Team to enhance your martial arts skills, discipline, and fitness while representing the university in competitions.
      </p>
